...
$(".banner-box-middle-box").mouseout(function () {
    banner_t = setInterval(banner_move, 2000);
})
...
$(".content2-middle-bottom").mouseout(function(){
    content2=setInterval(content2_move,2000);
})
